...
3. Check model_name in config_fig.yaml for the model to run. And also change use_lookup and ablate_vehicle etc.. parameters according to the model.

4. Run python train.py

5. Run python train_pytorch.py to run GraphKAN.
