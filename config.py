...
class Config(object):
    def __init__(self, config_path):
        ...
        with open(config_path, "r") as f:
            ...
            # Added Loader=yaml.FullLoader to the yaml.load() call
        ...
        self.ablate_vehicle = conf["ablate_vehicle"]
        self.ablate_arm = conf["ablate_arm"]
        self.ablate_periodicity = conf["ablate_periodicity"]
